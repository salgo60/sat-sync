...
(function() {{
  const i18n = {{
    sv: {{
      ...
      cardTodoListDesc: 'Uppgiftslista för fältarbete med filter per ö och objekttyp, checkboxar och export (JSON/CSV/Markdown).',
    ...
    en: {{
      ...
      cardTodoListDesc: 'Task list for field work with island/type filters, checkboxes, and export (JSON/CSV/Markdown).',
