...
<main>
  ...
  <section>
    ...
    <div class="flyer-grid">
      ...
      <a class="flyer-card" href="assets/sat-osm-infographic.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-osm-infographic.jpg" alt="OpenStreetMap-objekt längs Stockholm Archipelago Trail" loading="lazy">
      </a>
      <a class="flyer-card" href="assets/sat-osm-trail-infographic.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-osm-trail-infographic.jpg" alt="Stockholm Archipelago Trails ledhierarki i OpenStreetMap" loading="lazy">
      </a>
      <a class="flyer-card" href="assets/sat-osm-experience-infographic.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-osm-experience-infographic.jpg" alt="Från öppna data till rikare vandringsupplevelser" loading="lazy">
      </a>
      <a class="flyer-card" href="assets/sat-open-europe-flyer.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-open-europe-flyer.jpg" alt="Ett öppnare Europa för vandrare" loading="lazy">
      </a>
      <a class="flyer-card" href="assets/sat-open-data-chinese-flyer.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-open-data-chinese-flyer.jpg" alt="Öppna vandringsdata på kinesiska" loading="lazy">
      </a>
      <a class="flyer-card" href="assets/sat-community-collaboration-arabic-flyer.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-community-collaboration-arabic-flyer.jpg" alt="Från gemenskap till samverkan på arabiska" loading="lazy">
      </a>
      ...
      <a class="flyer-card" href="assets/sat-ssot-modell-tillforlitlig-information-flyer.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-ssot-modell-tillforlitlig-information-flyer.jpg" alt="SSOT-modell – från lekstuga till tillförlitlig information: ägarskap, källa, identifiering, proveniens, förvaltning och appar" width="1536" height="1024" loading="lazy">
      </a>
      <a class="flyer-card" href="assets/sat-ssot-model-data-management-flyer.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-ssot-model-data-management-flyer.jpg" alt="SSOT-modell för SAT – från dataägarskap och källor till identifierare, aktualitet, förvaltning och bättre friluftsupplevelser" width="1536" height="1024" loading="lazy">
      </a>
      ...
      <a class="flyer-card" href="assets/sat-id-datalager-flyer.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-id-datalager-flyer.jpg" alt="Ett datalager – sex slags beständiga identiteter: trail, section, poi, pier, vessel och report, alla med frysta SAT-ID:n" width="1672" height="941" loading="lazy">
      </a>
      <a class="flyer-card" href="assets/sat-kalldata-urval-flyer.jpg" target="_blank" rel="noopener">
        <img src="assets/sat-kalldata-urval-flyer.jpg" alt="SAT använder ett urval – källorna innehåller mycket mer: från rik källdata i OSM och Wikidata till ett användbart urval i SAT, samt hur man rättar vid källan via MapComplete" width="1672" height="941" loading="lazy">
      </a>
...
(function() {{
  ...
  const idToKey = {{
    ...
    'flyers-title':'flyersTitle','flyers-desc':'flyersDesc',
